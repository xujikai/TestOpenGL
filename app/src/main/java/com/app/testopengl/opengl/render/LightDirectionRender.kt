...
class LightDirectionRender: GLSurfaceView.Renderer {
    ...
    override fun onSurfaceCreated(gl: GL10, config: EGLConfig) {
        mProgram = GLComUtils.createProgram(R.raw.light_direction_vert_shader, R.raw.light_direction_frag_shader)
