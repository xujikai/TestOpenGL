...
#ifndef TESTOPENGL_TRANSITION02SAMPLE_H
#define TESTOPENGL_TRANSITION02SAMPLE_H
...
class Transition02Sample : public GLSampleBase {
public:
    ~Transition02Sample();
...
#endif //TESTOPENGL_TRANSITION02SAMPLE_H
