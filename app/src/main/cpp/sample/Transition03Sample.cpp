...
void Transition03Sample::Draw(int screenW, int screenH) {
...
void Transition03Sample::UnInit() {
    if (mProgramObj) {
...
void Transition03Sample::SetImageDataWithIndex(int index, NativeImage *pImage) {
    if (pImage) {
...
void Transition03Sample::UpdateMVPMatrix(glm::mat4 &mvpMatrix, int angleX, int angleY, float ratio) {
    LOGCATE("Transition03Sample::UpdateMVPMatrix angleX = %d, angleY = %d, ratio = %f", angleX, angleY, ratio);
    angleX = angleX % 360;
    angleY = angleY % 360;
