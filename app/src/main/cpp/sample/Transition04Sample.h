...
#ifndef TESTOPENGL_TRANSITION04SAMPLE_H
#define TESTOPENGL_TRANSITION04SAMPLE_H
...
class Transition04Sample : public GLSampleBase {
public:
    ~Transition04Sample();
...
#endif //TESTOPENGL_TRANSITION04SAMPLE_H
