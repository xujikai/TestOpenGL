...
#ifndef TESTOPENGL_TRANSITION01SAMPLE_H
#define TESTOPENGL_TRANSITION01SAMPLE_H
...
class Transition01Sample : public GLSampleBase {
public:
    ~Transition01Sample();
...
#endif //TESTOPENGL_TRANSITION01SAMPLE_H
