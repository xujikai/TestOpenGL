...
void Transition01Sample::Draw(int screenW, int screenH) {
...
void Transition01Sample::UnInit() {
    if (mProgramObj) {
...
void Transition01Sample::SetImageDataWithIndex(int index, NativeImage *pImage) {
    if (pImage) {
...
void Transition01Sample::UpdateMVPMatrix(glm::mat4 &mvpMatrix, int angleX, int angleY, float ratio) {
    LOGCATE("Transition01Sample::UpdateMVPMatrix angleX = %d, angleY = %d, ratio = %f", angleX, angleY, ratio);
    angleX = angleX % 360;
    angleY = angleY % 360;
