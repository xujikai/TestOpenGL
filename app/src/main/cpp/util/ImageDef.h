...
#ifndef TESTOPENGL_IMAGEDEF_H
#define TESTOPENGL_IMAGEDEF_H
...
//                }
    ...
    static void
    ConvertP010PlaneTo8Bit(uint16_t *pSrcData, uint8_t *pDstData, int width, int height) {
        if (pSrcData == nullptr
            || pDstData == nullptr
            || width <= 0
            || height <= 0)
